...
<html lang="en">
  ...
  <body>
          ...
          <!-- content starts -->
              <div>
                  <ul id="myTab" class="nav nav-tabs">
                      ...
                      <li ><a href="#ios" data-toggle="tab">审核记录</a></li>
                      <li ><a href="#inform" data-toggle="tab">通知记录</a></li>
                      ...
                      <li><a href="#addMessage" id="btn-add" data-toggle="tab" ><i class="glyphicon glyphicon-plus">新通知</i></a></li>
                  ...
                  <div class="tab-pane fade" id="inform">
                      <div class="box col-md-12">
                          <div class="box-inner">
                              ...
                              <div class="box-content">
                                  <table class="table table-striped table-bordered table-condensed" id="informTable">
                                  ...
                                  <form role="form" >
                                      <div class="form-group">
                                          <label for="newtitle">主题</label>
                                                    <span class="field">
                                                         <textarea rows="1" id="newtitle"  class="form-control" required></textarea>
                                                    </span>
                                      </div>
                                      ...
                                      <div class="form-group">
                                          <label for="newcontent">内容</label>
                                                    <span class="field">
                                                         <textarea  rows="15" id="newcontent"  class="form-control" required></textarea>
                                                    </span>
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-md-6" style="padding-left : 0px;margin-bottom : 15px">
                                              <select id="select2"  multiple row="1"  class="form-control" required></select>
                                          </div>
                                          <div class="col-md-6" id="foroptions" style="padding-right : 0px;margin-bottom : 15px">
                                      ...
                                      <div class="form-group">
                                         ...
                                         <button type="submit"  class="btn btn-success"  onclick="addapply()">  &nbsp; &nbsp; 发送 &nbsp; &nbsp;  </button>
                                      </div>
                                  </form>
                              </div>
                  ...
                  <div class="modal-body" >
                      ...
                      <form class="form-horizontal" role="form">
                          ...
                          <div class="form-group form-group-sm has-success">
                              <label class="col-sm-2 control-label">主题</label>
								<span class="field">
                                         <textarea cols="60" rows="1"  id="edit_self_title" class="longinput" disabled="disabled"></textarea>
                                </span>
                          </div>
                          <div class="form-group form-group-sm has-success">
                              <label class="col-sm-2 control-label">申请人</label>
								<span class="field">
                                         <textarea cols="60" rows="1" id="edit_self_create" class="longinput" disabled="disabled"></textarea>
                                </span>
                          </div>
                          <div class="form-group form-group-sm has-success">
                              <label class="col-sm-2 control-label">发送时间</label>
								<span class="field">
                                         <textarea cols="60" rows="1" id="edit_self_time" class="longinput" disabled="disabled"></textarea>
                                </span>
                          </div>
                          ...
                          <div class="form-group form-group-sm has-success">
                              <label class="col-sm-2 control-label">申请内容</label>
								<span class="field">
                                         <textarea cols="60" rows="8" id="edit_self_content" class="longinput" disabled="disabled"></textarea>
                                </span>
                          </div>
                          ...
                          <div class="form-group form-group-sm has-success">
                              <label class="col-sm-2 control-label">回复内容</label>
								<span class="field">
                                         <textarea cols="60" rows="8" id="edit_self_reply" class="longinput"></textarea>
                                </span>
                          </div>
                          <div class="form-group form-group-sm has-success " id="selectstate">
                              <label class="col-sm-2 control-label">是否批准</label>
                              <label class="radio-inline">
                                  <input type="radio" name="inlineRadioOptions" id="state1" value="1" checked>Y
                                  </label>
                              <label class="radio-inline">
                                  <input type="radio" name="inlineRadioOptions" id="state2" value="2">N
                              </label>
                          </div>
                      </form>
                  ...
                  <div class="modal-body" >
                      ...
                      <form class="form-horizontal" role="form">
                          ...
                          <div class="form-group form-group-sm has-success">
                              <label class="col-sm-2 control-label">主题</label>
								<span class="field">
                                         <textarea cols="60" rows="2" id="show_self_title" class="longinput"></textarea>
                                </span>
                          </div>
                          <div class="form-group form-group-sm has-success">
                              <label class="col-sm-2 control-label">发送时间</label>
								<span class="field">
                                         <textarea cols="60" rows="1" id="show_self_time" class="longinput"></textarea>
                                </span>
                          </div>
                          ...
                          <div class="form-group form-group-sm has-success">
                              <label class="col-sm-2 control-label">申请内容</label>
								<span class="field">
                                         <textarea cols="60" rows="10" id="show_self_content" class="longinput"></textarea>
                                </span>
                          </div>
                          <div class="form-group form-group-sm has-success">
                              <label class="col-sm-2 control-label">回复内容</label>
								<span class="field">
                                         <textarea cols="60" rows="10" id="show_self_reply" class="longinput"></textarea>
                                </span>
                          </div>
    ...
    <script src="js/apply_min.js"></script>
