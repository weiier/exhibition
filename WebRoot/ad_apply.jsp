              ...
              <div id="myTabContent" class="tab-content">
                  ...
                  <div class="tab-pane fade" id="addMessage">
                      <div class="box col-md-12">
                          <div class="box-inner">
                              <div class="box-content">
                                  <form role="form"  onsubmit="return addapply();" id="apply_form">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-md-12" style="padding-left : 0px;margin-bottom : 15px">
                                             <select id="dept" data-placeholder="请选择代理.."  class="chosen-select" multiple   >
                                              </select>
                                          </div>
                                      ...
                                      <div class="form-group">
                                         ...
                                         <button type="submit"  class="btn btn-success"  id="subA">  &nbsp; &nbsp; 发送 &nbsp; &nbsp;  </button>
                                      </div>
                                  </form>
                              </div>
...
<script src="js/bootstrap.min.js"></script>
    ...
    <script src="js/applyN.js"></script>
